...
export function SharedKitchenAuditPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#ece5da' }}>
      ...
      >
        <div>
          <p style={{ margin: 0, fontSize: '12px', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#7b6b54', fontWeight: 700 }}>
            Shared Report
          </p>
        ...
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
          ...
          <button
            ...
            onClick={() =>
              downloadText(
                `${title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '') || 'kitchen-audit-report'}.html`,
                documentHtml,
                'text/html'
              )
            }
