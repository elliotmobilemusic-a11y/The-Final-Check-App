// Single source of truth PDF CSS
const PDF_REPORT_CSS = `
/* ==========================================================================
    THE FINAL CHECK - PREMIUM PDF REPORT DESIGN SYSTEM
    Optimised for A4 PDF generation in Chromium/Electron
    ========================================================================== */
...
.pdf-cover-metric.primary .pdf-cover-metric-label {
  color: #aaaaaa;
}

.pdf-cover-metric-value {
  font-size: 38pt;
  font-weight: 700;
  letter-spacing: -0.02em;
  line-height: 1;
...
.pdf-chapter-header h2 {
  font-size: 24px;
  line-height: 1.02;
  letter-spacing: -0.04em;
}

.pdf-chapter-header p {
  color: #666666;
  max-width: 78ch;
  font-size: 12px;
  line-height: 1.7;
